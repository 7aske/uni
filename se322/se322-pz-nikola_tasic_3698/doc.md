...
**ID i naziv**:	UC-1 Kreiranje objave na forumu

**Kreator**:	Nikola Tasić

**Datum kreiranja**:	27.10.2020.

**Primarni akter**:	Korisnik	Sekundarni akteri:	Lekar

**Pokretač**:	Korisnik želi da postavi pitanje na forumu sistema AskDoc

**Opis**:	Korisniku omogućiti da može da kreira objavu na forumu.

**Preduslovi**:	

* *PRE-1.* Otvoren je period objavljivanja na forumu.

**Postuslovi**:	

* *POST-1.* Korisnik je uspešno kreirao objavu.

**Normalni tok**:	

* **1.0** Kreiranje objave

	- **1.1** Korisnik unosi naslov objave.

	- **1.2** Korisnik dodaje opcionu kategoriju objave.

	- **1.3** Korisnik unosi tekst objave.

	- **1.4** Korisnik potvrđuje kreiranje objave. E1

**Alternativni tokovi**:

* **1.1** Kreiranje objave za neulogovanog korisnika.

	- **1.1.1** Korisnik kreira objavu (UC.1.0)

	- **1.1.2** Korisnik nakon obaveštenja da nije ulogvan se loguje na sistem ili registruje nakon čega može da nastavi sa kreiranjem objave.

**Izuzeci**:

* **1.0** E1 Korisnik nije ulogovan

	- **1.1** Korisniku se ispisuje poruka sa obeaveštenjem da nije ulogovan i opcijama da se uloguje ili registruje pre nastavljanja.

**Prioritet**:	Visok

**Frekvencija upotrebe**:	1-10 puta nedeljno.

**Poslovna pravila**:	Korisnikova objava se ne vezuje s njegovim identitetom.

**Druge informacije**:	/

**Pretpostavke**:	Pretpostavlja se da je otvoren period za kreiranje objava/pitanja.

## UC-2 Pregled objava

**ID i naziv**:	UC-2 Pregled objava

**Kreator**: Nikola Tasić

**Datum kreiranja**: 27.10.2020.

**Primarni akter**:	Lekar

**Sekundarni akteri**:	

**Pokretač**:	Lekar vrši pregled objava.

**Opis**:	Lekaru omogućiti pregled objava koje su korisnici postavili na sistemu.

**Preduslovi**:	
	
* *PRE-1.* Otovoren je period objavljivanja na forumu.

* *PRE-2.* Lekar je autentifikovan na sistem.


**Postuslovi**:	

* *POST-1.* Lekar je pregledao objave.

**Normalni tok**:	

* **1.0** Pregled objava

	- **2.1** Lekar nakon odabira stavke u meniju za pregled objava dobija listu objava (E1.)

	- **2.2** Lekar klikom na naslov objave dobija tekst objave i više informacija o njoj.

**Alternativni tokovi**:	/

**Izuzeci**:

* **1.0** E1 Nije aktivan period objavljivanja

	- **1.1** Korisniku se prikazuje poruka sa obaveštenjem da nije aktivan period objavljivanja.

**Prioritet**:	Srednji

**Frekvencija upotrebe**:	40-100 puta nedeljno.

**Poslovna pravila**:	/

**Druge informacije**:	/

**Pretpostavke**:	Pretpostavlja se da je lekar uspešno autentifikovan.


## UC-3 Komentarisanje objave

**ID i naziv**:	UC-3 Komentarisanje objave

**Kreator**:	Nikola Tasić

**Datum kreiranja**:	28.10.2020.

**Primarni akter**:	Korisnik,Lekar

**Sekundarni akteri**:	 Lekar, Korisnik

**Pokretač**:	Korisnik želi da komentariše na objavu.

**Opis**:	Korisniku omogućiti komentarisanje na objavu.

**Preduslovi**:	

* *PRE-1.* Korisnik je autentifikovan na sistem.

**Postuslovi**:	

* *POST-1.* Korisnik je uspešno komentarisao na objavu.

**Normalni tok**:

* **1.0** Komentarisanje na objavu

	- **1.1** Korisnik je na stranici objave uneo tekst komentara.

	- **1.2** Korisnik šalje komentar pritiskom na dugme za slanje komentara. (E1)

**Alternativni tokovi**:	

**Izuzeci**:

* **1.0** E1 Objava je obrisana ili označena kao inaktivna

	- **1.1** Ako se desi da je objava obrisana ili označena kao neaktivna korisniku se prikazuje obaveštenje sa odgovarajućom porukom.

**Prioritet**:	Srednji

**Frekvencija upotrebe**:	200-1000 puta nedeljno.

**Poslovna pravila**:	Komentar ne sme da sadrži korisnikove informacije u slučaju da to nije lekar.

**Druge informacije**:	U kontekstu ovog slučaja korišćenja korisnik može da bude i lekar.

**Pretpostavke**:	Pretpostavlja se da je lekar uspešno autentifikovan.

## UC-4 Zakazivanje termina predavanja

## UC-5 Započinjanje predavanja
