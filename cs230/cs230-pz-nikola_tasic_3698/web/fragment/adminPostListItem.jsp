<li class="collection-item avatar">
    ...
    <p class="truncate" style="padding-right: 2em;"><%=request.getParameter("excerpt")%></p>
    <a href="${pageContext.request.contextPath}/admin/post/edit/${pageContext.request.getParameter("idPost")}" class="secondary-content"><i class="material-icons orange-text">edit</i></a>
</li>
